    ...
    <div class="relative isolate overflow-hidden bg-gray-800 py-24 sm:py-32">
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-300"><span>{{ date_format($event->start_date, 'F j') }}@if($event->end_date)- {{ date_format($event->end_date, 'F j') }}@endif</span></p>
          ...
          <ol role="list" class="flex items-center space-x-4">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">{{$event->title}}</a>
              </div>
            </li>
          </ol>
        </nav>
