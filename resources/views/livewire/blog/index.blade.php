      ...
      <div class="mt-16 space-y-20 lg:mt-20 lg:space-y-20">
        ...
        <article class="relative isolate flex flex-col gap-8 lg:flex-row">
          <div class="relative aspect-[16/9] sm:aspect-[2/1] lg:aspect-square lg:w-64 lg:shrink-0">
            <img src="{{$post->image ? Storage::disk('vultr')->url($post->image) : config('app.url') .'/images/devotional-placeholder.jpg' }}" alt="" class="absolute inset-0 h-full w-full rounded-2xl bg-gray-50 object-cover">
          ...
          <div>
            <div class="flex items-center gap-x-4 text-xs">
              ...
              <a href="/blog/{{$post->slug}}" class="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100">Marketing</a>
            </div>
