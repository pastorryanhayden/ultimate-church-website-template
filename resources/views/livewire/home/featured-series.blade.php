  ...
  <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
    ...
    <div class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:grid-rows-2 sm:gap-x-6 lg:gap-8">
       ...
       <div class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-h-1 sm:aspect-w-2 sm:row-span-2 sm:col-span-2">
        <img src="{{ $single->photo ? '/' . $single->photo : '/images/devotional-placeholder.jpg' }}" alt="{{$single->desciption}}" class="object-cover object-center group-hover:opacity-75">
      ...
      <div class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-none sm:relative sm:h-full">
        <img src="{{ $single->photo ? '/' . $single->photo : '/images/devotional-placeholder.jpg' }}" class="object-cover object-center group-hover:opacity-75 sm:absolute sm:inset-0 sm:h-full sm:w-full">
