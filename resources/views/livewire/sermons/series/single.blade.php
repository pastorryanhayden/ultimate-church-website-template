<div x-data="{ showDetails: true }">
    ...
    @if($series->photo)
    <img src="/{{ $series->photo }}" alt="" class="w-full max-w-lg mx-auto mb-12">
    @else 
    <img src="{{env('APP_URL')}}/images/devotional-placeholder.jpg" alt="" class="w-full max-w-lg mx-auto mb-12">
    @endif 
