<div>
    <div class="relative isolate overflow-hidden bg-gray-700 py-24 sm:py-32">
        <img src="{{ Storage::disk('vultr')->url($ministry->image) }}" alt=""
        ...
        <ol role="list" class="flex items-center space-x-4">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/ministries"
                        class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Ministries</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700"
                        aria-current="page">{{ $ministry->name }}</a>
                </div>
            </li>
        </ol>
    </nav>
