<footer class="bg-gray-700">
    ...
    <div class="grid w-full md:grid-cols-2 lg:grid-cols-4 gap-6 px-8">
        <article>
            <h3 class="text-2xl font-sans uppercase font-bold mb-2"><?php echo e(env('CHURCH_NAME')); ?></h3>
...
<?php /**PATH /Users/ryanhayden/Herd/examplesite/resources/views/livewire/footer.blade.php ENDPATH**/ ?>