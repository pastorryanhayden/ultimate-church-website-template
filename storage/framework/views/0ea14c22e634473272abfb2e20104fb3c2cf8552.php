<div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 mb-24">
  <img src="<?php echo e(Storage::disk('vultr')->url($details->image)); ?>" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center">
  <div class="hidden sm:absolute sm:inset-0 sm:-z-10 sm:block bg-gray-700 opacity-80">
  </div>
...
<?php /**PATH /Users/ryanhayden/Herd/examplesite/resources/views/livewire/about/header.blade.php ENDPATH**/ ?>