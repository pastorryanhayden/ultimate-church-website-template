...
<?php endif; ?> 
        <hgroup>
        <h2>Experience <?php echo e(env('CHURCH_NAME')); ?></h2>
        <h4>Join us this week for church</h4>
        </hgroup>
        <section class="grid">
            <article>
            <h3><?php echo e(env('CHURCH_NAME')); ?></h3>
        ...
        </footer><?php /**PATH /Users/ryanhayden/Herd/biblebaptistmattoon/resources/views/partials/_footer.blade.php ENDPATH**/ ?>