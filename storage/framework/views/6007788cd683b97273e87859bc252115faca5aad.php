...
$__html = app('livewire')->mount($__name, $__params, 'yJsQ2Ai', $__slots ?? [], get_defined_vars());
      ...
      <div class="space-y-20">
        ...
        <article class="relative isolate flex flex-col gap-8 lg:flex-row">
          <div class="relative aspect-[16/9] sm:aspect-[2/1] lg:aspect-square lg:w-64 lg:shrink-0">
            <img src="<?php echo e(asset('storage/' . $ministry->image )); ?>" alt="" class="absolute inset-0 h-full w-full  bg-gray-50 object-cover">
...
<?php /**PATH /Users/ryanhayden/Herd/biblebaptistmattoon/resources/views/livewire/ministries/index.blade.php ENDPATH**/ ?>