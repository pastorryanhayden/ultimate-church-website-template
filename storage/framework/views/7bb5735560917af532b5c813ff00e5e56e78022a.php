<div>
   <div class="bg-gray-900 px-6 py-12 sm:py-12 lg:px-8">
          ...
          <ol role="list" class="flex items-center space-x-4">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page"><?php echo e($post->title); ?></a>
              </div>
            </li>
          </ol>
        </nav>
      <img src="<?php echo e($post->image ? Storage::disk('vultr')->url($post->image) : env('APP_URL') .'/images/devotional-placeholder.jpg'); ?>" alt="" class="w-full  max-w-4xl mx-auto">  
      <div class="bg-white px-6 py-24 sm:py-32 lg:px-8">
          <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl"><?php echo e($post->title); ?></h2>
    ...
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 prose">
        <?php echo app(App\Services\MarkdownService::class)->toHtml($post->body); ?>
    </div>
    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('blog.morefrom', ['author' => ''.e($post->author->id).'','post' => ''.e($post->id).'']);

$__html = app('livewire')->mount($__name, $__params, '2pDPDXC', $__slots ?? [], get_defined_vars());
...
?> 
</div><?php /**PATH /Users/ryanhayden/Herd/biblebaptistmattoon/resources/views/livewire/blog/single.blade.php ENDPATH**/ ?>