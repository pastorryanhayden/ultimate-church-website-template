<div>
    <div class="bg-gray-800 px-6 py-12 sm:py-12 lg:px-8">
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-white sm:text-5xl">Devotion: <?php echo e($devotion->title); ?></h2>
      </div>
    </div>
          ...
          <ol role="list" class="flex items-center space-x-4">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page"><?php echo e($devotion->title); ?></a>
              </div>
            </li>
          </ol>
        </nav>
    ...
    <iframe 
    src="https://www.youtube.com/embed/<?php echo e($devotion->video_url); ?>" 
    frameborder="0" 
    ...
    <img src="/<?php echo e($devotion->image_url); ?>" alt="" class="w-full  max-w-4xl mx-auto">
    <?php endif; ?> 
    <?php if($devotion->audio_url): ?>
    <audio controls class="w-full mt-6 max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
        <source src="/<?php echo e($devotion->audio_url); ?>" type="audio/mpeg">
    ...
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 prose">
        <?php echo app(App\Services\MarkdownService::class)->toHtml($devotion->body); ?>
    </div>
</div>
<?php /**PATH /Users/ryanhayden/Herd/biblebaptistmattoon/resources/views/livewire/devotion/single.blade.php ENDPATH**/ ?>