<div>
   <div class="bg-gray-900 px-6 py-12 sm:py-12 lg:px-8">
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-white sm:text-5xl">Sermons</h2>
      </div>
    </div>
    <div>
        <?php if (isset($component)) { $__componentOriginal42687394209a6157c6bd072eaf19d515aa4e1649 = $component; } ?>
<?php $component = App\View\Components\Sermontabs::resolve(['selected' => 'Sermons'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /Users/ryanhayden/Herd/biblebaptistmattoon/resources/views/livewire/sermons/index.blade.php ENDPATH**/ ?>